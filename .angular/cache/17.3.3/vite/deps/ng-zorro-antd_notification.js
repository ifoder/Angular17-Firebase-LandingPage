...
function NzNotificationComponent_Conditional_2_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(1);
    ɵɵproperty("ngTemplateOutlet", ctx)("ngTemplateOutletContext", ɵɵpureFunction1(2, _c1, ctx_r11));
  }
}
function NzNotificationComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let NzNotificationComponent_Conditional_2_contFlowTmp;
    ɵɵadvance(2);
    ɵɵclassProp("ant-notification-notice-with-icon", ctx_r1.instance.type !== "blank");
    ɵɵadvance(1);
    ɵɵconditional(3, (NzNotificationComponent_Conditional_2_contFlowTmp = ctx_r1.instance.type) === "success" ? 3 : NzNotificationComponent_Conditional_2_contFlowTmp === "info" ? 4 : NzNotificationComponent_Conditional_2_contFlowTmp === "warning" ? 5 : NzNotificationComponent_Conditional_2_contFlowTmp === "error" ? 6 : -1);
    ɵɵadvance(5);
    ɵɵproperty("nzStringTemplateOutlet", ctx_r1.instance.title);
    ɵɵadvance(2);
    ɵɵproperty("nzStringTemplateOutlet", ctx_r1.instance.content);
    ɵɵadvance(1);
    ɵɵconditional(11, (NzNotificationComponent_Conditional_2_contFlowTmp = ctx_r1.instance.options == null ? null : ctx_r1.instance.options.nzButton) ? 11 : -1, NzNotificationComponent_Conditional_2_contFlowTmp);
  }
}
...
function NzNotificationContainerComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelementStart(0, "nz-notification", 6);
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_2_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r11.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzNotificationContainerComponent_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_5_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r18.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const instance_r13 = ctx.$implicit;
    ɵɵproperty("instance", instance_r13)("placement", "topRight");
  }
}
function NzNotificationContainerComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_8_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r25.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const instance_r20 = ctx.$implicit;
    ɵɵproperty("instance", instance_r20)("placement", "bottomLeft");
  }
}
function NzNotificationContainerComponent_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_11_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r32.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const instance_r27 = ctx.$implicit;
    ɵɵproperty("instance", instance_r27)("placement", "bottomRight");
  }
}
function NzNotificationContainerComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_14_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r39.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const instance_r34 = ctx.$implicit;
    ɵɵproperty("instance", instance_r34)("placement", "top");
  }
}
function NzNotificationContainerComponent_For_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("destroyed", function NzNotificationContainerComponent_For_17_Template_nz_notification_destroyed_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r46.remove($event.id, $event.userAction));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const instance_r41 = ctx.$implicit;
    ɵɵproperty("instance", instance_r41)("placement", "bottom");
  }
}
...
_NzNotificationComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 7,
  vars: 5,
  consts: [[1, "ant-notification-notice", "ant-notification-notice-closable", 3, "ngStyle", "ngClass", "click", "mouseenter", "mouseleave"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["tabindex", "0", 1, "ant-notification-notice-close", 3, "click"], [1, "ant-notification-notice-close-x"], [1, "ant-notification-notice-content"], [1, "ant-notification-notice-message"], [4, "nzStringTemplateOutlet"], [1, "ant-notification-notice-description"], ["class", "ant-notification-notice-btn"], ["nz-icon", "", "nzType", "check-circle", 1, "ant-notification-notice-icon", "ant-notification-notice-icon-success"], ["nz-icon", "", "nzType", "info-circle", 1, "ant-notification-notice-icon", "ant-notification-notice-icon-info"], ["nz-icon", "", "nzType", "exclamation-circle", 1, "ant-notification-notice-icon", "ant-notification-notice-icon-warning"], ["nz-icon", "", "nzType", "close-circle", 1, "ant-notification-notice-icon", "ant-notification-notice-icon-error"], [3, "innerHTML"], [1, "ant-notification-notice-btn"], ["nz-icon", "", 3, "nzType"], ["nz-icon", "", "nzType", "close", 1, "ant-notification-close-icon"]],
...
_NzNotificationContainerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 18,
  vars: 40,
  consts: [[1, "ant-notification", "ant-notification-topLeft"], [1, "ant-notification", "ant-notification-topRight"], [1, "ant-notification", "ant-notification-bottomLeft"], [1, "ant-notification", "ant-notification-bottomRight"], [1, "ant-notification", "ant-notification-top"], [1, "ant-notification", "ant-notification-bottom"], [3, "instance", "placement", "destroyed"], [3, "instance", "placement"]],
  template: function NzNotificationContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementStart(0, "div", 0);
      ɵɵrepeaterCreate(1, NzNotificationContainerComponent_For_2_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(3, "div", 1);
      ɵɵrepeaterCreate(4, NzNotificationContainerComponent_For_5_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(6, "div", 2);
      ɵɵrepeaterCreate(7, NzNotificationContainerComponent_For_8_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(9, "div", 3);
      ɵɵrepeaterCreate(10, NzNotificationContainerComponent_For_11_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(12, "div", 4);
      ɵɵrepeaterCreate(13, NzNotificationContainerComponent_For_14_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
      ɵɵelementStart(15, "div", 5);
      ɵɵrepeaterCreate(16, NzNotificationContainerComponent_For_17_Template, 1, 2, "nz-notification", 7, ɵɵrepeaterTrackByIdentity);
      ɵɵelementEnd();
    }
    if (rf & 2) {
