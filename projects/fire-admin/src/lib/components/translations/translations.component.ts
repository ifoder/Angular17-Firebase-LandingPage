...
export class TranslationsComponent implements OnInit, OnDestroy, AfterViewInit {
      ...
      .then((exists: boolean) => {
        if (exists) {
          ...
          this.translations
            ...
            .then(() => {
              this.alert.success(
                this.i18n.get('TranslationAdded'),
                false,
                5000
              );
            })
  ...
  deleteTranslation(translation: TranslationData) {
    this.translations
      .delete(translation.key, translation.lang)
      .then(() => {
        this.alert.success(
          this.i18n.get('TranslationDeleted', { key: translation.key }),
          false,
          5000
        );
      })
  ...
  editTranslation(translation: TranslationData) {
    this.translations
      ...
      .then(() => {
        this.alert.success(
          this.i18n.get('TranslationSaved', { key: translation.key }),
          false,
          5000
        );
      })
